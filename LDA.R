...
#====   school, gps, env, trawl, bio, ctd data   ====#
lapply(c("Data/sandeel.Rdata", "Data/gps.Rdata", "Data/School_EROS_bio.df", "Data/spdf.Rdata", "Data/env.Rdata", "Data/ctd_EROS.Rdata", "Data/School_SD.Rdata"),load,.GlobalEnv)

load("School_EROS.Rdata")
...
load("S2019847_PEROS_3317/BIOLOGY/stationIndividuals.Rdata")
...
p<-ggplot(data = w) + geom_sf() + theme_bw(base_size=15) +
  ...
  #geom_path(data=EROS.df, aes(x=Longitude, y=Latitude), size=.1, colour="red")+
  labs(x="Longitude", y="Latitude")
#
